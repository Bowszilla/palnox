    ...
    >
      <div className="w-full max-w-sm">
        ...
        >
          ...
          {success ? (
            <div
              className="rounded-md px-4 py-4 text-[13px] font-body text-center space-y-1"
              style={{ background: 'rgba(46,183,107,0.10)', color: 'var(--success-400)', border: '1px solid rgba(46,183,107,0.25)' }}
            >
              <p className="font-semibold text-[15px]">Compte créé !</p>
              <p>Vérifie ta boîte mail pour confirmer ton adresse.</p>
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="flex flex-col gap-1.5">
                <label htmlFor="username" className="font-display font-semibold text-[12px] tracking-[0.04em] uppercase text-ink-3">
                  Nom de dresseur
                </label>
                <input
                  id="username"
              ...
              <div className="flex flex-col gap-1.5">
                <label htmlFor="email" className="font-display font-semibold text-[12px] tracking-[0.04em] uppercase text-ink-3">
                  Email
                </label>
                <input
                  id="email"
